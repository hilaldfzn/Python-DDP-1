...
# Meminta input user untuk banyak tempat wisata
...
while banyak_tempat_wisata <= 0:
    ...
    banyak_tempat_wisata = int(input("Masukkan banyak tempat wisata kamu yang kamu kunjungi: "))

# Inisialisasi data untuk perjalanan Dek Depe
tingkat_kebahagiaan = 0
rating_tertinggi = 0
perjalanan_paling_berkesan = ""
...
for i in range(banyak_tempat_wisata):
    ...
    if rating >= rating_tertinggi:
        perjalanan_paling_berkesan = tujuan_wisata
        rating_tertinggi = rating

# Menghitung skala kebahagiaan dan mencetak ringkasan perjalanan Dek Depe
rata_rata_kebahagiaan = tingkat_kebahagiaan / banyak_tempat_wisata

print()
print("---Summary---")
print(f"Perjalanan paling mengesankan adalah ketika pergi ke {perjalanan_paling_berkesan}." )
print(f"Skala kebahagiaan Dek Depe adalah {rata_rata_kebahagiaan:.2f}")

# Pengecekan rating experience Dek Depe
